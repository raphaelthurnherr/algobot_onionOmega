...
${OBJECTDIR}/asyncTools/asyncSTEPPER.o: asyncTools/asyncSTEPPER.c
	${MKDIR} -p ${OBJECTDIR}/asyncTools
	${RM} "$@.d"
	$(COMPILE.c) -g -DI2CSIMU -IhwControl/libs/i2c -IhwControl/libs/onion-debug -IAlgoidCom/libs/lib_json -IAlgoidCom/libs/lib_mqtt -IAlgoidCom -IhwControl -IasyncTools -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/asyncTools/asyncSTEPPER.o asyncTools/asyncSTEPPER.c

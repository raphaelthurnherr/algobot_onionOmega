...
${OBJECTDIR}/asyncTools/asnycLED.o: asyncTools/asnycLED.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/asyncTools/asnycLED.o asyncTools/asnycLED.c

${OBJECTDIR}/asyncTools/asyncMOTOR.o: asyncTools/asyncMOTOR.c
	${MKDIR} -p ${OBJECTDIR}/asyncTools
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/asyncTools/asyncMOTOR.o asyncTools/asyncMOTOR.c
...
${OBJECTDIR}/hwControl/boardHWctrl.o: hwControl/boardHWctrl.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/hwControl/boardHWctrl.o hwControl/boardHWctrl.c

${OBJECTDIR}/hwControl/hwManager.o: hwControl/hwManager.c
	${MKDIR} -p ${OBJECTDIR}/hwControl
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/hwControl/hwManager.o hwControl/hwManager.c

${OBJECTDIR}/hwControl/libs/i2c/onion-i2c.o: hwControl/libs/i2c/onion-i2c.c
	${MKDIR} -p ${OBJECTDIR}/hwControl/libs/i2c
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/hwControl/libs/i2c/onion-i2c.o hwControl/libs/i2c/onion-i2c.c
...
${OBJECTDIR}/hwControl/libs/onion-debug/onion-debug.o: hwControl/libs/onion-debug/onion-debug.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/hwControl/libs/onion-debug/onion-debug.o hwControl/libs/onion-debug/onion-debug.c
